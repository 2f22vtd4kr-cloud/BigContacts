...
const checks = [
  ...
  ["target Dig filters source URLs against observed trajectory", target.includes("observedUrlsFromTrajectory") && target.includes("sourceBackedFindings(agentic.findings, agentic.trajectory)")],
  ...
  ["strict boundary requires explicit run-scoped provenance", strict.includes("observedSourceBackedBureauContacts") && strict.includes("observedSourceUrls") && !strict.includes("getDiscoveryTrace")],
