...
assert(/requestedIterations > 0 \? Math\.min\(requestedIterations, MAX_ITER\) : MAX_ITER/.test(source), "invalid/non-positive caller input fails closed to the bounded runtime action ceiling");
