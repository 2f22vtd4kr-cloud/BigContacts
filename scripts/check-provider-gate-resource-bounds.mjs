...
const checks = [
  ...
  ["cache keys strip credential query parameters case-insensitively", /QUERY_CREDENTIAL_KEYS/.test(source) && /stripCredentialQueryParams\(parsed\)/.test(source) && /key\.toLowerCase\(\)/.test(source)],
