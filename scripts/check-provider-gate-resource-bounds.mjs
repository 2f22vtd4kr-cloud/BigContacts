...
const checks = [
  ...
  ["provider/account state keys remain composite and bounded", /providerStateKey\(provider:string,account:string\):string=>`\$\{provider\}\|\$\{account\}`/.test(source) && /maxProviderStates\(\)/.test(source)],
];
