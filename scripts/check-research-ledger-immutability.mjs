...
console.log("RESEARCH LEDGER IMMUTABILITY: PASS — PostgreSQL rejects mutation, blocks conflicting correlation-key replays, and startup fails closed if the ledger is absent");
