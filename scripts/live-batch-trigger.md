...
Last intentional production-candidate audit trigger: 2026-09-25 (canonical provider-path verification after removing deterministic Investigator strategy scoring). This marker exists solely to launch the isolated GitHub Actions live proof workflow; it is not a runtime feature or research instruction.
