...
const checks = [
  ...
  ["target Investigator serializes durable action callbacks", target.includes("investigationEventChain = investigationEventChain.then")],
  ["target Investigator drains durable action callbacks before completion", target.includes("await investigationEventChain;")],
