...
export default function NotFound() {
  return (
    <div className="flex h-full flex-col items-center justify-center bg-[#050505] px-4 py-16 text-stone-100">
      <div className="grid h-14 w-14 place-items-center rounded-2xl border border-[#e85d1a]/30 bg-[#e85d1a]/10 text-[#e85d1a]">
      ...
      <div className="mt-8 flex flex-wrap items-center justify-center gap-2">
        <Link
          href="/"
          className="atlas-pressable inline-flex min-h-[44px] items-center rounded-xl bg-[#e85d1a] px-5 text-xs font-bold text-black hover:brightness-105"
        >
          Overview
        </Link>
        <Link
