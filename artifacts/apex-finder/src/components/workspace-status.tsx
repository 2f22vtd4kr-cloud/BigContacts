...
const STATE_COPY: Record<WorkspaceState, {
  ...
  researching: {
    ...
    dotClassName: "bg-emerald-300 shadow-[0_0_8px_rgba(103,232,249,0.7)]",
  },
  "researching-degraded": {
    ...
    dotClassName: "bg-[#00e68a] shadow-[0_0_8px_rgba(0,230,138,0.55)]",
  },
  queued: {
    label: "ATLAS STANDBY",
    shortLabel: "QUEUE",
    ...
    <div ref={rootRef} className="relative">
      <button
        ...
        className={cn(
          ...
          "border-[#00e68a]/15 bg-background/70 hover:border-primary/40 hover:bg-muted/50",
          (state === "degraded" || state === "researching-degraded" || state === "offline") && "border-[#00e68a]/30",
        )}
      >
          ...
          <div className="mt-3 space-y-2">
            <div className="rounded-lg border border-border/60 bg-background/70 px-3 py-2.5">
              <div className="flex items-center justify-between gap-3">
                <span className="font-mono text-[9px] uppercase tracking-[0.16em] text-muted-foreground/60">Research engine</span>
                  <span className={cn("font-mono text-[10px] font-bold", active ? (providerDegraded ? "text-[#a7f3d0]" : "text-emerald-300") : schedulerEnabled ? "text-[#a7f3d0]" : "text-muted-foreground")}>
            ...
            <div className="grid grid-cols-2 gap-2">
              <div className="rounded-lg border border-border/60 px-3 py-2">
                ...
                <div className={cn("mt-1 font-mono text-[11px] font-bold", servicesHealthy ? "text-primary" : "text-[#a7f3d0]")}>
              ...
              <div className="rounded-lg border border-border/60 px-3 py-2">
                ...
                <div className={cn("mt-1 font-mono text-[11px] font-bold", summary.active > 0 ? "text-primary" : "text-[#a7f3d0]")}>
            ...
            <div className="rounded-lg border border-border/60 bg-background/70 px-3 py-2.5">
              <div className="flex items-center justify-between gap-3">
                ...
                <span className={cn("font-mono text-[10px] font-bold", servicesHealthy ? "text-primary" : "text-[#a7f3d0]")}>
                  {databaseState}
                </span>
              </div>
