    ...
    <div
      ...
      className={
        critical
          ...
          : "border-b border-emerald-500/35 bg-emerald-950/80 px-3 py-2.5 text-emerald-50 sm:px-5"
      }
    >
      <div className="mx-auto flex max-w-[1400px] items-start gap-2.5">
        <AlertTriangle
          className={`mt-0.5 h-4 w-4 shrink-0 ${critical ? "text-rose-300" : "text-emerald-300"}`}
          aria-hidden
        />
