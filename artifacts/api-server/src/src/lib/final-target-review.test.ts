...
import { adjudicateFinalTargetReview } from "./final-target-review";
...
describe("adjudicateFinalTargetReview conflict fencing", () => {
  it("cannot bypass contact conflict fencing through approvedRelatedValues", () => {
  ...
  it("still permits a non-conflicted related value", () => {
    const result = adjudicateFinalTargetReview(
      { ...baseInput, candidates: [candidate({ conflictCount: 0, vectorType: "role", value: "Director" })] },
      {
        decision: "publish",
