...
export const GROQ_CHAT_MODELS: readonly string[] = unique([configuredAgenticModel, process.env.GROQ_MODEL, process.env.GROQ_CHAT_MODEL, "qwen/qwen3.8-27b", "openai/gpt-oss-120b", "openai/gpt-oss-20b"]);
