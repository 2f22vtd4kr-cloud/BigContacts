...
async function runDataEngineer(entity: Entity): Promise<ImprovementSuggestion[]> {
  ...
  if (isDirectTarget) {
    ...
    suggestions.push({
      ...
      description:
        "No validated direct phone on record. Treat social handles, asset operators, FBOs, marinas, and private club staff as evidence only; do not infer a personal route.",
      actionTaken: "Queued for evidence-quality review and public contact attribution.",
    });
  }
