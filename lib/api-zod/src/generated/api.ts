...
export const ListEntitiesQueryParams = zod.object({
  ...
  "offset": zod.coerce.number().int().default(listEntitiesQueryOffsetDefault),
...
export const ListAssetsResponseItem = zod.object({
  ...
  "ownerEntityId": zod.number().int().nullish(),
...
export const CreateAssetBody = zod.object({
  ...
  "ownerEntityId": zod.number().int().optional()
})
...
export const ListRelationshipsQueryParams = zod.object({
  "entityId": zod.coerce.number().int().optional().describe('Filter by source entity ID')
})

export const ListRelationshipsResponseItem = zod.object({
  "id": zod.number().int(),
  "sourceEntityId": zod.number().int(),
...
export const RunResearchResponse = zod.object({
  ...
  "realismClass": zod.string().nullish(),
  "realismReason": zod.string().nullish(),
  "researchBudget": zod.string().nullish(),
  "createdAt": zod.string()
})
...
export const ListResearchSessionsQueryParams = zod.object({
  ...
  "limit": zod.coerce.number().int().default(listResearchSessionsQueryLimitDefault)
})
...
export const GetHotLeadsQueryParams = zod.object({
  "limit": zod.coerce.number().int().default(getHotLeadsQueryLimitDefault)
})
...
export const GetDashboardStatsResponse = zod.object({
  "totalEntities": zod.number().int(),
  "totalAssets": zod.number().int(),
  "totalRelationships": zod.number().int(),
  "avgBayesianScore": zod.number(),
  "hotLeadsCount": zod.number().int(),
  "activeResearchSessions": zod.number().int(),
...
export const GetEntityGraphQueryParams = zod.object({
  "depth": zod.coerce.number().int().default(getEntityGraphQueryDepthDefault)
})
...
export const GetConnectionPathQueryParams = zod.object({
  "sourceId": zod.coerce.number().int(),
  "targetId": zod.coerce.number().int()
})
...
export const RunImprovementLoopBody = zod.object({
  "limit": zod.number().int().default(runImprovementLoopBodyLimitDefault),
  "entityIds": zod.array(zod.number().int()).optional()
})
...
export const ListImprovementLogsQueryParams = zod.object({
  "limit": zod.coerce.number().int().default(listImprovementLogsQueryLimitDefault),
  "offset": zod.coerce.number().int().default(listImprovementLogsQueryOffsetDefault),
...
export const RunOccrpEnrichmentBody = zod.object({
  "limit": zod.number().int().default(runOccrpEnrichmentBodyLimitDefault).describe('Max entities to enrich')
})
...
export const RunLandRegistryIngestionBody = zod.object({
  "maxRecords": zod.number().int().default(runLandRegistryIngestionBodyMaxRecordsDefault),
