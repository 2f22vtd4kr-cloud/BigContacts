...
export const researchSessionsTable = pgTable("research_sessions", {
  ...
  realismClass: text("realism_class"), // direct | intermediary | bounded | research_only
  realismReason: text("realism_reason"),
  researchBudget: text("research_budget"), // full | bounded | review_only
