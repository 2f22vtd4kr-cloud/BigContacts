...
- [Research quota safety](research-quota-safety.md) — Gemini Flash-Lite, per-key spacing, and serialized one-target research prevent quota bursts and overlapping work
