...
- **Upstash Redis (`REDIS_URL_1`)** — ⚠️ NOT SET this import — dedup won't persist across restarts
- **SESSION_SECRET** — ✅ Set
- **COMPANIES_HOUSE_API_KEY** — ⚠️ NOT SET this import — CH officer enrichment skipped
