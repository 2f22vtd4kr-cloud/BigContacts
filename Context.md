...
- The previous discovery-first Atlas job `feae7d88-3eee-48ae-99ee-7e9071801989` was safely marked failed by cold-start recovery after an API process interruption at Phase 8, J4–J9 pass 41/50, with 40 persisted inserts and 0 recorded target errors. A new sequential job `1141a101-ffad-4fc0-a9b6-65e6e968fe2c` is active at Phase 0 pre-run cross-references; API/Redis health is green.
...
| 2026-08-04 | **Atlas process recovery and live telemetry activation**: The prior run reached Phase 8, J4–J9 pass 41/50 with 40 inserted targets and 0 target errors before the API process was interrupted; cold-start recovery preserved the failed state and released the lock. The API was rebuilt and restarted safely, then a new sequential discovery-first job `1141a101-ffad-4fc0-a9b6-65e6e968fe2c` was launched with the durable telemetry/persona code active. Phase 0 is running; OCCRP/Aleph authorization and rate-limit failures remain non-blocking and visible. |
