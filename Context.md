...
> **Import #26 note:** pnpm install (~22s). DB schema pushed (additive). Redis ✅, API Server ✅ (port 8080), Web Frontend ✅ (port 23695). Cold-start auto-recovery detected empty DB → FAA (30k) + HMLR (2k) auto-ingested; Western HNWI running in background. SESSION_SECRET ✅. REDIS_URL_1 ⚠️ NOT SET — dedup won't persist. REDIS_URL_2 ⚠️ NOT SET — contact cache unavailable. COMPANIES_HOUSE_API_KEY ⚠️ NOT SET.
...
| Date | What changed |
|---|---|
| 2026-07-21 | **Re-import #26 setup**: pnpm install, DB schema pushed. Redis ✅ · API Server ✅ (port 8080) · Web Frontend ✅ (port 23695). SESSION_SECRET ✅. REDIS_URL_1 ⚠️ NOT SET · REDIS_URL_2 ⚠️ NOT SET · COMPANIES_HOUSE_API_KEY ⚠️ NOT SET. DB empty at boot → FAA 30k + HMLR 2k auto-ingested; Western HNWI running in background. |
