...
## Current State (2026-08-04 — Atlas active; mobile Reactor live research console)

- The previous discovery-first Atlas job `1141a101-ffad-4fc0-a9b6-65e6e968fe2c` was safely marked failed by cold-start recovery after an intentional API restart at Phase 8, J4–J9 pass 36/50, with 35 persisted inserts and 0 recorded target errors. The optional candidate-funnel persistence guard was built and committed before restart. A new sequential job `4813e6e4-64a5-4272-9417-6818d7a2b1ea` is active with the updated API; API/Redis health is green.
