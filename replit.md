...
| `GEMINI_API_KEY_11`–`_13` | Replit Secrets (optional) | Dedicated Gemini Deep Research Pro Preview pool; used only by explicit target-scoped review jobs, never by continuous Atlas |
...
| **Current controlled development runtime** | **15 visible / 0 hot** | **13** | 0 relationships, 2 active research-review sessions, 0 personal contactable routes, 6 organization routes, and no validated or promoted direct contacts; Atlas is idle after successful recovery. |
