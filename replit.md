...
| `GEMINI_API_KEY`, `_1`–`_10` | Replit Secrets (optional) | Google Gemini Flash-Lite access with key rotation; the future Boss uses the cost-safe `gemini-3.1-flash-lite` model |
