...
**Branch:** `main`  
**Current GitHub code tip:** `d2b57aecc64b7fef72e0b5db7d6be5394df0c0d3`  
**Product:** Apex Atlas research bureau embedded in BigContacts.

## ReAct architecture status
...
- Explicit `mode="discovery"` with empty target name at canonical Atlas/Bureau boundary; the historical `Discovery slot` fake target is removed from canonical Atlas.
