...
Permitted non-LLM capabilities include search, HTTP/page visits, browser/fetch, RDAP/WhoisJSON, registries, public footprinting and approved OSINT executors.
